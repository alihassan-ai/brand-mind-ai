 ...
 */
export async function compileBrandDNA(shopId) {
    ...
    return {
        ...
        toneAttributes: (voice === null || voice === void 0 ? void 0 : voice.toneAttributes) || [],
        neverLanguage: (voice === null || voice === void 0 ? void 0 : voice.neverLanguage) || [],
        ...
        riskTolerance: (governance === null || governance === void 0 ? void 0 : governance.riskTolerance) || 'medium',
        priorityAreas: (governance === null || governance === void 0 ? void 0 : governance.priorityAreas) || [],
        northStarMetric: (kpi === null || kpi === void 0 ? void 0 : kpi.northStarMetric) || 'Revenue',
    };
}
/**
 * Generate the system prompt for LLM calls based on Brand DNA.
 */
export function generateBrandSystemPrompt(dna) {
