...
function calculateStoreFitScore(input) {
    ...
    if (topTypes.some((t) => { var _a; return (_a = t.type) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(candidateType.toLowerCase()); })) {
        score += 0.3;
    }
    // Check if it matches the price sweet spot
    const priceSweetSpot = ((_a = dna.priceSweetSpot) === null || _a === void 0 ? void 0 : _a.sweetSpot) || '';
...
function calculateGapFillScore(input) {
    ...
    for (const gap of catalogGaps) {
        ...
        if (gap.gapType === 'price_gap') {
            const band = ((_a = gapData.band) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || '';
        ...
        if (gap.gapType === 'category_gap') {
            const missingCategory = ((_b = gapData.missingCategory) === null || _b === void 0 ? void 0 : _b.toLowerCase()) || '';
        ...
        if (gap.gapType === 'variant_gap') {
            const colorValue = ((_c = gapData.value) === null || _c === void 0 ? void 0 : _c.toLowerCase()) || '';
...
function calculateCompetitionScore(input) {
    ...
    if (decliningTypes.some((t) => { var _a; return (_a = t.type) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(candidateType.toLowerCase()); })) {
        return 0.3;
    }
    // If category is growing, good opportunity
    const growingTypes = storeDNA.growingTypes || [];
    if (growingTypes.some((t) => { var _a; return (_a = t.type) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(candidateType.toLowerCase()); })) {
        return 0.8;
    }
...
export async function scoreCandidate(input) {
    ...
    const finalScore = storeFitScore * SCORING_WEIGHTS.storeFit +
 ...
 */
export async function scoreCandidateWithAudit(input) {
 ...
 */
export async function scoreCandidates(shopId, candidates) {
...
function generateScoringExplanation(scores) {
    const parts = [];
    if (scores.storeFitScore > 0.7)
        parts.push('Strong store DNA match');
    else if (scores.storeFitScore < 0.4)
        parts.push('Limited store fit');
    if (scores.gapFillScore > 0.6)
    ...
    if (scores.competitionScore > 0.7)
