...
// MAIN FUNCTION
// ============================================
export async function checkDataSufficiency(shopId) {
    const blockers = [];
    const warnings = [];
    const estimates = [];
    // ═══════════════════════════════════════════════════════════════
...
// ============================================
export async function getDataSufficiency(shopId) {
...
// ============================================
export async function canUseFeature(shopId, feature) {
