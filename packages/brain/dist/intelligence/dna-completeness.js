...
// MAIN FUNCTION
// ============================================
export async function checkDNACompleteness(shopId) {
    ...
    for (const fieldDef of IDENTITY_FIELDS) {
        const value = dna === null || dna === void 0 ? void 0 : dna[fieldDef.field];
        ...
        if (isEmpty) {
            ...
            if (fieldDef.importance === 'critical')
                identityMissingCritical.push(fieldDef.field);
            else if (fieldDef.importance === 'important')
                identityMissingImportant.push(fieldDef.field);
            else
                identityMissingOptional.push(fieldDef.field);
        }
        else {
            identityFilled++;
        }
    ...
    for (const fieldDef of MARKET_POSITION_FIELDS) {
        ...
        if (isEmpty) {
            ...
            if (fieldDef.importance === 'critical')
                marketMissingCritical.push(fieldDef.field);
            else if (fieldDef.importance === 'important')
                marketMissingImportant.push(fieldDef.field);
            else
                marketMissingOptional.push(fieldDef.field);
        }
        else {
            marketFilled++;
        }
    ...
    if (!(dna === null || dna === void 0 ? void 0 : dna.avgOrderValue)) {
    ...
    if (!(dna === null || dna === void 0 ? void 0 : dna.priceBands)) {
    ...
    if (!(dna === null || dna === void 0 ? void 0 : dna.totalProducts) || dna.totalProducts < 5) {
    ...
    if (!(dna === null || dna === void 0 ? void 0 : dna.seasonalityCurve)) {
        dataRequired.push({
            field: 'seasonality',
            section: 'operationalDNA',
            source: 'shopify_orders',
    ...
    if (!(dna === null || dna === void 0 ? void 0 : dna.heroProductShare)) {
        dataRequired.push({
    ...
    if (!(dna === null || dna === void 0 ? void 0 : dna.repeatPurchaseRate)) {
    ...
    if (!(dna === null || dna === void 0 ? void 0 : dna.basketAffinities)) {
        dataRequired.push({
    ...
    if (!(dna === null || dna === void 0 ? void 0 : dna.segmentDistribution)) {
        dataRequired.push({
    ...
    if (!(dna === null || dna === void 0 ? void 0 : dna.entryProducts)) {
        dataRequired.push({
            field: 'entryProducts',
            section: 'customerDNA',
            source: 'shopify_orders',
    ...
    const overallScore = Math.round((identityScore * 0.30) +
        (marketScore * 0.25) +
...
// UPDATE DNA FIELD
// ============================================
export async function updateDNAField(shopId, field, value) {
    const updateData = {};
    ...
    await prisma.storeDNA.upsert({
        where: { shopId },
        update: updateData,
        create: Object.assign({ shopId }, updateData),
    });
