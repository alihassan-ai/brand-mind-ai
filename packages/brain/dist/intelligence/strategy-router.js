...
// MAIN FUNCTION
// ============================================
export function determineExpansionStrategy(signals) {
    const alternatives = [];
    // ═══════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════
    if (signals.heroProductShare > 40 &&
    ...
    // ═══════════════════════════════════════════════════════════════
    if (signals.inferredCashPosition === 'cash_rich' &&
    ...
    // ═══════════════════════════════════════════════════════════════
    if (signals.categoryDepth === 'shallow' &&
    ...
    // ═══════════════════════════════════════════════════════════════
    if (signals.seasonalPosition === 'pre_peak' &&
...
// ============================================
export async function getStrategyRecommendation(shopId) {
    ...
    const signals = {
        heroProductShare: (_a = dna.heroProductShare) !== null && _a !== void 0 ? _a : 0,
        top5ProductShare: (_b = dna.top5ProductShare) !== null && _b !== void 0 ? _b : 0,
        concentrationRisk: (_c = dna.concentrationRisk) !== null && _c !== void 0 ? _c : 'medium',
        orderVelocityTrend: (_d = dna.orderVelocityTrend) !== null && _d !== void 0 ? _d : 'stable',
        revenueGrowth30d: (_e = dna.revenueGrowth30d) !== null && _e !== void 0 ? _e : 0,
        marginHealthStatus: (_f = dna.marginHealthStatus) !== null && _f !== void 0 ? _f : 'moderate',
        inferredCashPosition: (_g = dna.inferredCashPosition) !== null && _g !== void 0 ? _g : 'balanced',
        cashCowProductCount: (_h = dna.cashCowProductCount) !== null && _h !== void 0 ? _h : 0,
        starProductCount: (_j = dna.starProductCount) !== null && _j !== void 0 ? _j : 0,
        categoryDepth: (_k = dna.categoryDepth) !== null && _k !== void 0 ? _k : 'moderate',
        categoryBreadth: (_l = dna.categoryBreadth) !== null && _l !== void 0 ? _l : 'moderate',
        seasonalPosition: (_m = dna.seasonalPosition) !== null && _m !== void 0 ? _m : 'off_season',
        monthsUntilPeak: (_o = dna.monthsUntilPeak) !== null && _o !== void 0 ? _o : 6,
    };
