      ...
      <div className="w-full max-w-md relative animate-slide-up">
        ...
        <div className="bg-[var(--background-card)] border border-[var(--border)] rounded-2xl p-8 space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-[var(--muted-foreground)]">Sign in to your BrandMindAI account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-[var(--primary)] hover:text-[var(--primary-hover)] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
        ...
        <p className="text-center text-[var(--muted-foreground)] text-sm mt-6">
          ...
          <Link href="/auth/signup" className="text-[var(--primary)] hover:text-[var(--primary-hover)] font-medium transition-colors">
            Sign up
          </Link>
        </p>
      </div>
