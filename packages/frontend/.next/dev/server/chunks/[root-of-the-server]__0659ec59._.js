...
"[project]/packages/brain/src/intelligence/store-dna.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function calculateProductVelocities(shopId) {
    ...
    const products = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.findMany({
        where: {
            shopId
        },
        select: {
    ...
    for (const product of products){
        ...
        const totalSales = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].orderLineItem.aggregate({
            where: {
        ...
        const sales30d = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].orderLineItem.aggregate({
            where: {
                productId: product.shopifyId,
                order: {
                    shopId,
        ...
        const sales60d = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].orderLineItem.aggregate({
            where: {
                productId: product.shopifyId,
                order: {
                    shopId,
...
async function analyzePriceBands(shopId) {
    ...
    const lineItems = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].orderLineItem.findMany({
        where: {
            order: {
                shopId
            }
    ...
    const refunds = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].refund.findMany({
        where: {
            order: {
                shopId
            }
    ...
    const variants = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].variant.findMany({
        where: {
            product: {
                shopId
            }
...
async function analyzeSeasonality(shopId) {
    ...
    const orders = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.findMany({
        where: {
            shopId
        },
        select: {
...
async function computeStoreDNA(shopId) {
    ...
    const crossPurchasePattern = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patternMemory.findUnique({
        where: {
            shopId_patternType: {
                shopId,
    ...
    // Upsert to database
    const storeDNA = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].storeDNA.upsert({
        where: {
            shopId
        },
        update: {
...
"[project]/packages/brain/src/intelligence/gap-detector.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function detectAllGaps(shopId) {
    ...
    for (const gap of allGaps){
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].catalogGap.upsert({
            where: {
...
"[project]/packages/brain/src/intelligence/trends.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getTrendData(keyword, region = 'US') {
    // Check cache first
    const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].trendData.findUnique({
        where: {
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].trendData.upsert({
            where: {
                keyword_region_source: {
                    keyword,
                    region,
...
"[project]/packages/brain/src/intelligence/evidence.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function calculateDataQuality(shopId) {
    ...
    const syncStates = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].syncState.findMany({
        where: {
            shopId
        },
        orderBy: {
    ...
    const [products, orders, customers] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.count({
            where: {
                shopId
            }
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.count({
            where: {
                shopId
            }
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.count({
            where: {
                shopId
            }
        })
    ...
    const ordersWithCustomers = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.count({
        where: {
            shopId,
            customerId: {
                not: null
    ...
    const productsWithTypes = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.count({
        where: {
            shopId,
            productType: {
                not: null
...
async function validateClaim(shopId, claim, type) {
    switch(type){
        case 'product':
            ...
            if (productMatch) {
                const product = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.findFirst({
                    where: {
                        shopId,
                        title: {
...
"[project]/packages/brain/src/intelligence/public-analyzer.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/brain/src/intelligence/product-research.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/openai/index.mjs [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$client$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__OpenAI__as__default$3e$__ = __turbopack_context__.i("[project]/node_modules/openai/client.mjs [app-route] (ecmascript) <export OpenAI as default>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$trends$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/trends.ts [app-route] (ecmascript)");
;
;
;
...
async function buildStoreContext(shopId) {
    ...
    if (!shop) return null;
    const storeDNA = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].storeDNA.findUnique({
        where: {
            shopId
        }
    });
    const dnaData = storeDNA;
    const patterns = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patternMemory.findMany({
        where: {
            shopId
        }
    });
    ...
    const brandVoice = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].brandVoice.findUnique({
        where: {
            shopId
        }
    });
...
async function gatherTrendInsights(categories) {
    ...
    for (const category of categories.slice(0, 3)){
        try {
            const trendData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$trends$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTrendData"])(category, 'DE'); // German market
...
"[project]/packages/brain/src/intelligence/data-sufficiency.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function checkDataSufficiency(shopId) {
    ...
    const [orderStats, productStats, customerStats] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.aggregate({
            where: {
                shopId
            },
            _count: true,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.aggregate({
            where: {
                shopId
            },
            _count: true
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.aggregate({
            where: {
                shopId
            },
            _count: true
    ...
    const ordersWithMultipleItems = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.findMany({
        where: {
            shopId
        },
        select: {
    ...
    const categories = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.groupBy({
        by: [
            'productType'
        ],
        where: {
    ...
    try {
        const repeatCustomers = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$queryRaw`
    ...
    // SAVE TO DATABASE
    // ═══════════════════════════════════════════════════════════════
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dataSufficiency.upsert({
        where: {
            shopId
        },
        update: {
...
async function getDataSufficiency(shopId) {
    const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dataSufficiency.findUnique({
        where: {
            shopId
        }
    });
...
"[project]/packages/brain/src/intelligence/dna-completeness.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function checkDNACompleteness(shopId) {
    const dna = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].storeDNA.findUnique({
        where: {
            shopId
        }
    });
    ...
    // ═══════════════════════════════════════════════════════════════
    if (dna) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].storeDNA.update({
            where: {
                shopId
            },
            data: {
...
async function updateDNAField(shopId, field, value) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].storeDNA.upsert({
        where: {
            shopId
        },
        update: updateData,
...
"[project]/packages/brain/src/intelligence/strategy-router.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/brain/src/intelligence/dna-seeder.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function seedDNAFromShopify(shopId) {
    ...
    const existingDna = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].storeDNA.findUnique({
        where: {
            shopId
        }
    });
    if (existingDna) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].storeDNA.create({
            data: {
                shopId,
                ...dnaData
            }
...
async function gatherShopifyMetrics(shopId) {
    const [orderAgg, productAgg, customerAgg, products, recentOrdersCount] = await Promise.all([
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.findMany({
            where: {
                shopId
            },
            select: {
    ...
    const lineItemsWithRevenue = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].orderLineItem.groupBy({
        by: [
            'productId'
        ],
        where: {
    ...
    const topProductDetails = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.findMany({
        where: {
            id: {
                in: topProductIds
            }
...
"[project]/packages/brain/src/intelligence/insights-engine.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function calculateCatalogHealth(shopId) {
    const dnaRaw = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].storeDNA.findUnique({
        where: {
            shopId
        }
    });
...
async function suggestBundles(shopId) {
    const crossPurchase = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patternMemory.findUnique({
        where: {
            shopId_patternType: {
                shopId,
                patternType: 'cross_purchase'
...
async function getPriceAlerts(shopId) {
    const pricePattern = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patternMemory.findUnique({
        where: {
            shopId_patternType: {
                shopId,
...
async function getSeasonalCalendar(shopId) {
    const seasonal = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patternMemory.findUnique({
        where: {
            shopId_patternType: {
                shopId,
...
"[project]/packages/brain/src/agents/launch-kit-agent.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function generatePricingStrategy(input) {
    ...
    const topProducts = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.findMany({
        where: {
            shopId: input.shopId
        },
        orderBy: {
...
async function generateLaunchKit(input) {
    ...
    // Save to database
    const launchKit = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].launchKit.create({
        data: {
            shopId: input.shopId,
...
async function getLaunchKits(shopId) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].launchKit.findMany({
        where: {
            shopId
        },
        orderBy: {
...
async function getLaunchKit(id) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].launchKit.findUnique({
        where: {
            id
        }
    });
...
"[project]/packages/brain/src/agents/retention-agent.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function calculateRFM(shopId) {
    ...
    const customers = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.findMany({
        where: {
            shopId
        },
        select: {
    ...
    for (const data of rfmData){
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customerRFM.upsert({
            where: {
...
async function generateRetentionInsights(shopId) {
    ...
    for (const insight of insights){
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].retentionInsight.create({
            data: {
                shopId,
...
async function getRetentionSummary(shopId) {
    const rfm = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customerRFM.findMany({
        where: {
            shopId
        }
    });
    ...
    const insights = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].retentionInsight.findMany({
        where: {
            shopId,
            status: 'active'
        },
...
"[project]/packages/brain/src/nexthit/candidate-scorer.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function loadScoringContext(shopId, candidates) {
    const [storeDNA, catalogGaps, patterns, existingProducts] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].storeDNA.findUnique({
            where: {
                shopId
            }
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].catalogGap.findMany({
            where: {
                shopId,
                status: 'active'
            }
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patternMemory.findMany({
            where: {
                shopId
            }
        }),
    ...
    for (const keyword of keywordsArray){
        try {
            const trend = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$trends$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTrendData"])(keyword);
...
async function persistCandidates(shopId, candidates) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].nextHitCandidate.deleteMany({
        where: {
            shopId,
            status: 'generated'
        }
    ...
    // Insert new top 10
    for (const candidate of candidates){
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].nextHitCandidate.create({
            data: {
                shopId,
                title: candidate.title,
...
"[project]/packages/brain/src/nexthit/deterministic-scorer.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/nexthit/candidate-scorer.ts [app-route] (ecmascript)");
;
;
;
;
...
async function scoreCandidate(input) {
    ...
    const finalScore = storeFitScore * __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCORING_WEIGHTS"].storeFit + gapFillScore * __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCORING_WEIGHTS"].gapFill + trendMomentum * __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCORING_WEIGHTS"].trendMomentum + marginPotential * __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCORING_WEIGHTS"].marginPotential + competitionScore * __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCORING_WEIGHTS"].competition + seasonalityMatch * __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCORING_WEIGHTS"].seasonalityMatch;
    const scores = {
    ...
    return {
        ...
        inputHash,
        scores,
        weights: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCORING_WEIGHTS"],
        version: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCORING_VERSION"],
        explanation
    };
}
async function scoreCandidateWithAudit(input) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].scoringAudit.create({
        data: {
            candidateId: input.candidateId,
...
"[project]/packages/brain/src/nexthit/candidate-generator.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/shared/src/index.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/shared/src/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$product$2d$research$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/product-research.ts [app-route] (ecmascript)");
;
;
 ...
 */ async function generateGapCandidates(shopId, dnaData) {
    const candidates = [];
    const gaps = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].catalogGap.findMany({
        where: {
            shopId,
            status: 'active'
        },
 ...
 */ async function generateAIResearchedCandidates(shopId) {
    ...
    const researchResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$product$2d$research$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["researchNewProducts"])(shopId);
    const candidates = [];
...
async function getTopProducts(shopId) {
    ...
    const metrics = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productMetric.groupBy({
        by: [
            'variantId'
        ],
        where: {
    ...
    const products = await Promise.all(metrics.map(async (m)=>{
        const variant = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].variant.findUnique({
            where: {
                id: m.variantId
            },
            include: {
...
"[project]/packages/brain/src/nexthit/deep-analyzer.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function runDeepAnalysis(candidateId) {
    const candidate = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].nextHitCandidate.findUnique({
        where: {
            id: candidateId
        },
        include: {
    ...
    const analysis = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].nextHitAnalysis.upsert({
        where: {
            candidateId
        },
        update: {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].nextHitCandidate.update({
        where: {
            id: candidateId
        },
        data: {
...
"[project]/packages/brain/src/nexthit/background-analyzer.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function analyzeColorPatterns(shopId) {
    ...
    if (winners.length > 0) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patternMemory.upsert({
            where: {
                shopId_patternType: {
                    shopId,
...
async function analyzeSeasonalPatterns(shopId) {
    ...
    const metrics = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dailyMetric.findMany({
        where: {
            shopId,
            date: {
                gte: last12Months
...
"[project]/packages/brain/src/nexthit/outcome-tracker.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function recordLaunchDecision(candidateId, decision, reason, launchDate) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].nextHitOutcome.upsert({
        where: {
            candidateId
        },
        update: {
...
async function recordLaunchPerformance(candidateId, metrics) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].nextHitOutcome.update({
        where: {
            candidateId
        },
        data: {
...
async function analyzeOutcomes(shopId) {
    const outcomes = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].nextHitOutcome.findMany({
        where: {
            candidate: {
                shopId
            },
...
"[project]/packages/brain/src/engine/metrics.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function aggregateDailyMetrics(shopId, date) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dailyMetric.upsert({
        where: {
            shopId_date: {
                shopId,
                date: startOfDay
 ...
 */ async function calculateCustomerSegmentation(shopId, todaysOrders, beforeDate) {
    ...
    for (const customerId of customerIds){
        const previousOrderCount = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.count({
            where: {
                shopId,
                customerId,
                createdAt: {
...
async function aggregateProductMetrics(shopId, date) {
    ...
    for (const [variantId, stats] of Object.entries(variantStats)){
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productMetric.upsert({
            where: {
                variantId_date: {
...
"[project]/packages/brain/src/compiler.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function compileBrandDNA(shopId) {
    const [identity, governance, voice, kpi, persona] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].brandIdentity.findUnique({
            where: {
                shopId
            }
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].decisionGovernance.findUnique({
            where: {
                shopId
            }
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].brandVoice.findUnique({
            where: {
                shopId
            }
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].kPIModel.findUnique({
            where: {
                shopId
            }
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customerPersona.findFirst({
            where: {
                shopId,
                isPrimary: true
            }
...
"[project]/packages/brain/src/engine/orchestrator.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/shared/src/index.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/shared/src/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/engine/metrics.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$compiler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/compiler.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
async function explainRecommendation(shopId, candidate) {
    const openai = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$client$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__OpenAI__as__default$3e$__["default"]();
    const memory = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].businessMemorySnapshot.findFirst({
        where: {
            shopId
        },
        orderBy: {
    ...
    const activeGoal = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].goal.findFirst({
        where: {
            shopId
        },
        orderBy: {
...
async function askTheBusiness(shopId, question) {
    ...
    const brandDNA = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$compiler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compileBrandDNA"])(shopId);
    const brandSystemPrompt = brandDNA ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$compiler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateBrandSystemPrompt"])(brandDNA) : 'You are BrandMindAI, an AI assistant for Shopify merchants.';
    ...
    const topProducts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTopProducts"])(shopId, 10);
    // Get recent refunds for quality-related questions
    const last7Days = new Date();
    last7Days.setDate(last7Days.getDate() - 7);
    const recentRefunds = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].refund.findMany({
        where: {
            order: {
                shopId
            },
...
"[project]/packages/brain/src/engine/goals.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function setGoal(shopId, type, params) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].goal.create({
        data: {
            shopId,
            type,
...
"[project]/packages/brain/src/engine/decision.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$goals$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/engine/goals.ts [app-route] (ecmascript)");
;
class EngineModule {
}
class DecisionEngine {
    ...
    async rankCandidates(shopId, candidates) {
        const weights = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$goals$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGoalWeights"])(shopId);
...
"[project]/packages/brain/src/engine/executive-dashboard.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function calculateExecutiveKPIs(shopId) {
    ...
    const currentMetrics = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dailyMetric.findMany({
        where: {
            shopId,
            date: {
                gte: last7Days
    ...
    const previousMetrics = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dailyMetric.findMany({
        where: {
            shopId,
            date: {
                gte: prev7Days,
    ...
    const variantsWithCost = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].variant.findMany({
        where: {
            cost: {
                not: null
            }
...
async function generateExecutiveBrief(shopId, kpis) {
    ...
    try {
        const { OpenAI } = await __turbopack_context__.A("[project]/node_modules/openai/index.mjs [app-route] (ecmascript, async loader)");
...
"[project]/packages/brain/src/rag/context.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function buildStoreContext(shopId) {
    // Get product stats
    const productCount = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.count({
        where: {
            shopId
        }
    });
    ...
    // Get order stats
    const orderCount = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.count({
        where: {
            shopId
        }
    });
    const orderStats = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.aggregate({
        where: {
            shopId
        },
        _sum: {
    ...
    const customerCount = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.count({
        where: {
            shopId
        }
    });
    const refundCount = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].refund.count({
        where: {
            order: {
                shopId
            }
    ...
    const recentOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.findMany({
        where: {
            shopId
        },
        orderBy: {
...
${productList}
    ...
    const lineItems = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].orderLineItem.groupBy({
        by: [
            'title'
        ],
        where: {
...
"[project]/packages/brain/src/index.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$store$2d$dna$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/store-dna.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$gap$2d$detector$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/gap-detector.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$trends$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/trends.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$evidence$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/evidence.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$public$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/public-analyzer.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$product$2d$research$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/product-research.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$data$2d$sufficiency$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/data-sufficiency.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$dna$2d$completeness$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/dna-completeness.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$strategy$2d$router$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/strategy-router.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$dna$2d$seeder$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/dna-seeder.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$insights$2d$engine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/insights-engine.ts [app-route] (ecmascript)");
// Agents
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$agents$2f$launch$2d$kit$2d$agent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/agents/launch-kit-agent.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$agents$2f$retention$2d$agent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/agents/retention-agent.ts [app-route] (ecmascript)");
// NextHit Engine
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$deterministic$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/brain/src/nexthit/deterministic-scorer.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$generator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/nexthit/candidate-generator.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/nexthit/candidate-scorer.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$deep$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/nexthit/deep-analyzer.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$background$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/nexthit/background-analyzer.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$outcome$2d$tracker$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/nexthit/outcome-tracker.ts [app-route] (ecmascript)");
// Engine modules
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/engine/metrics.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$orchestrator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/engine/orchestrator.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$decision$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/engine/decision.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$executive$2d$dashboard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/engine/executive-dashboard.ts [app-route] (ecmascript)");
// RAG
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$rag$2f$context$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/rag/context.ts [app-route] (ecmascript)");
// Compiler
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$compiler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/compiler.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$orchestrator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$executive$2d$dashboard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$orchestrator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$engine$2f$executive$2d$dashboard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
"[project]/packages/frontend/src/app/api/dna/update/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/brain/src/index.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$dna$2d$completeness$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/intelligence/dna-completeness.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/shared/src/index.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/shared/src/prisma.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
async function POST(req) {
    try {
        const shopDomain = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$auth$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnectedShop"])();
        if (!shopDomain) {
        ...
        // Update the field
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$dna$2d$completeness$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateDNAField"])(shop.id, field, value);
        // Return updated completeness
        const completeness = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$dna$2d$completeness$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkDNACompleteness"])(shop.id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            completeness
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0659ec59._.js.map