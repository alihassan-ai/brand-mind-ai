...
"[project]/packages/brain/src/nexthit/deterministic-scorer.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "SCORING_VERSION",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["SCORING_VERSION"],
    "SCORING_WEIGHTS",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["SCORING_WEIGHTS"],
    "scoreCandidate",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$deterministic$2d$scorer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["scoreCandidate"],
    "scoreCandidateWithAudit",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$deterministic$2d$scorer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["scoreCandidateWithAudit"],
    "scoreCandidates",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$deterministic$2d$scorer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["scoreCandidates"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$deterministic$2d$scorer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/brain/src/nexthit/deterministic-scorer.ts [app-rsc] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/brain/src/nexthit/candidate-scorer.ts [app-rsc] (ecmascript)");
}),
"[project]/packages/frontend/src/app/actions/nexthit.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

/* __next_internal_action_entry_do_not_use__ [{"0058028587441435f25f14842a580364f44a80d02d":"generateNextHit"},"",""] */ __turbopack_context__.s([
    "generateNextHit",
    ()=>generateNextHit
]);
...
;
;
async function generateNextHit() {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].nextHitOutcome.deleteMany({
            where: {
                candidate: {
                    shopId: shop.id
                }
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].scoringAudit.deleteMany({
            where: {
                candidate: {
                    shopId: shop.id
                }
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].nextHitAnalysis.deleteMany({
            where: {
                candidate: {
                    shopId: shop.id
                }
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$background$2d$analyzer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["runBackgroundAnalysis"])(shop.id);
        // Step 1.5: Refresh StoreDNA to ensure topPerformingTypes is populated
        const { seedDNAFromShopify } = await __turbopack_context__.A("[project]/packages/brain/src/index.ts [app-rsc] (ecmascript, async loader)");
        await seedDNAFromShopify(shop.id);
        // Step 2: Generate raw candidates
        const rawCandidates = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$generator$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateCandidates"])(shop.id);
        // Step 3: Score and filter to top 10 (legacy scorer)
        const top10 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$candidate$2d$scorer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["scoreAndFilterCandidates"])(shop.id, rawCandidates);
        // Step 3.5: Run deterministic scoring with audit trail on top candidates
        let storeDNA = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].storeDNA.findUnique({
            where: {
                shopId: shop.id
            }
        });
        ...
        if (!storeDNA) {
            ...
            storeDNA = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$store$2d$dna$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["computeStoreDNA"])(shop.id);
        }
        const catalogGaps = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].catalogGap.findMany({
            where: {
                shopId: shop.id,
                status: 'active'
            }
        ...
        for (const candidate of top10.slice(0, 5)){
            const dbCandidate = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].nextHitCandidate.findFirst({
                where: {
                    shopId: shop.id,
                    title: candidate.title
                }
            ...
            if (dbCandidate) {
                ...
                try {
                    ...
                    trendResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$intelligence$2f$trends$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTrendData"])(keyword, 'US');
                } catch (e) {
                ...
                const scoringInput = {
                    ...
                    seasonalityData: storeDNA?.seasonalityCurve || []
                };
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$deterministic$2d$scorer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["scoreCandidateWithAudit"])(scoringInput);
            }
        }
        ...
        for (const candidate of top10.slice(0, 3)){
            ...
            if (dbCandidate) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$brain$2f$src$2f$nexthit$2f$deep$2d$analyzer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["runDeepAnalysis"])(dbCandidate.id);
            }
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('/nexthits');
}
;
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ensureServerEntryExports"])([
    generateNextHit
]);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(generateNextHit, "0058028587441435f25f14842a580364f44a80d02d", null);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
"[project]/packages/frontend/.next-internal/server/app/(app)/product-intelligence/next-hit/page/actions.js { ACTIONS_MODULE0 => \"[project]/packages/frontend/src/app/actions/nexthit.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$frontend$2f$src$2f$app$2f$actions$2f$nexthit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
"[project]/packages/frontend/.next-internal/server/app/(app)/product-intelligence/next-hit/page/actions.js { ACTIONS_MODULE0 => \"[project]/packages/frontend/src/app/actions/nexthit.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "0058028587441435f25f14842a580364f44a80d02d",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$frontend$2f$src$2f$app$2f$actions$2f$nexthit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateNextHit"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$frontend$2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$product$2d$intelligence$2f$next$2d$hit$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$packages$2f$frontend$2f$src$2f$app$2f$actions$2f$nexthit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/packages/frontend/.next-internal/server/app/(app)/product-intelligence/next-hit/page/actions.js { ACTIONS_MODULE0 => "[project]/packages/frontend/src/app/actions/nexthit.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$frontend$2f$src$2f$app$2f$actions$2f$nexthit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/frontend/src/app/actions/nexthit.ts [app-rsc] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$frontend$2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$product$2d$intelligence$2f$next$2d$hit$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$packages$2f$frontend$2f$src$2f$app$2f$actions$2f$nexthit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$frontend$2f$src$2f$app$2f$actions$2f$nexthit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$frontend$2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$product$2d$intelligence$2f$next$2d$hit$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$packages$2f$frontend$2f$src$2f$app$2f$actions$2f$nexthit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$frontend$2f$src$2f$app$2f$actions$2f$nexthit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__07453e3f._.js.map